...
class Ui_Dialog_connection(object):
    def setupUi(self, Dialog_connection):
        ...
        Dialog_connection.resize(414, 151)
        ...
        self.gridLayout.addWidget(self.pushButton_cancel, 3, 3, 1, 1)
        self.pushButton_connect = QtWidgets.QPushButton(Dialog_connection)
        self.pushButton_connect.setObjectName("pushButton_connect")
        self.gridLayout.addWidget(self.pushButton_connect, 3, 2, 1, 1)
        self.lineEdit_user = QtWidgets.QLineEdit(Dialog_connection)
        self.lineEdit_user.setObjectName("lineEdit_user")
        self.gridLayout.addWidget(self.lineEdit_user, 1, 1, 1, 3)
        self.label_user = QtWidgets.QLabel(Dialog_connection)
    ...
    def retranslateUi(self, Dialog_connection):
        ...
        self.label_user.setText(_translate("Dialog_connection", "User"))
